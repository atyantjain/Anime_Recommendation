...
title_bg = get_base64_image(str(Path("assets") / "dan.png"))
...
with st.sidebar:
    st.header("Data")
    csv_path = st.text_input("Path to clean CSV", value=str(Path("data") / "anime_complete.csv"))
    st.caption("Put your CSV in the data/ folder or provide a full path.")
